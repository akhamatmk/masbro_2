...
<html lang="en">
    <head>
        ...
        <title>ADMIN Admin Masbro</title>
        <!-- plugins:css -->
                ...
                <div class="navbar-menu-wrapper d-flex align-items-center">                   
                    <ul class="navbar-nav navbar-nav-right">
                        <li class="nav-item dropdown d-none d-xl-inline-block">
                            ...
                            <img class="img-xs rounded-circle" src="{{ asset('images/profile-picture-user/'.Auth::user()->profile_image) }}" alt="Profile image">
                            </a>
                ...
                <nav class="sidebar sidebar-offcanvas" id="sidebar">
                    <ul class="nav">
                            ...
                            <div class="nav-link">
                                <div class="user-wrapper">
                                    <div class="profile-image">
                                        <img src="{{ asset('images/profile-picture-user/'.Auth::user()->profile_image) }}" alt="profile image">
                                    </div>
                        ...
                        <li class="nav-item">
                            ...
                            <span class="menu-title">Job Profesion</span>
                            <i class="menu-arrow"></i>
                            </a>
                            <div class="collapse" id="auth">
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('parent-profesion') }}"> Parent Profesion </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('child-profesion') }}"> Child Profesion </a>
                                    </li>                                    
                                </ul>
                            </div>
                        </li>
